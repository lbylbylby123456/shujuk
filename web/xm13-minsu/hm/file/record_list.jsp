								...
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="row">
											<div class="col-md-6">
												<%--<div class="btn-group">--%>
													<%--<a id="add_button" class="btn green" href="record_add_div.jsp" data-target="#ajax" data-toggle="modal">添加新记录 <i class="fa fa-plus"></i> </a>--%>
												<%--</div>--%>
												<div class="btn-group">
												...
												<div class="btn-group">
													<a id="return_button" class="btn green">返回 <i class="fa fa-edit"></i> </a>
												</div>
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/hm/record_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->