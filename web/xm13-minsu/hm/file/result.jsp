								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-actions right1">
											...
											<%--<button type="button" id="download_button" class="btn green" onclick="downloadFile()">--%>
												<%--下载--%>
											<%--</button>--%>
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/hm/result.js" type="text/javascript"></script>
<%--<script>--%>
	<%--function downloadFile(){--%>
		<%--if("<%=fileName%>" != "null") {--%>
			<%--var url = "../../hm_down/" + "<%=fileName%>";--%>
			<%--if(confirm("你确定要下载吗？")){--%>
				<%--window.open(url);--%>
			<%--}--%>
		<%--}--%>
