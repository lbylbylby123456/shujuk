									...
									<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" id="name" name="name" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/hm/hm_query.js" type="text/javascript"></script>
