								...
								<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
									...
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<select class="be-select form_control" id="sort_01" onchange="Page.sortRecord(1);">
											...
											<div class="col-md-3">
												<select class="be-select form_control" id="sort_02" onchange="Page.sortRecord(2);">
													<option value="">请选择</option>
													<option value="CONVERT(name using gbk)">按名称</option>
													<option value="price">按价格</option>
													<option value="create_time">按创建时间</option>
											...
											<div class="col-md-3">
												<select class="be-select form_control" id="sort_03" onchange="Page.sortRecord(3);">
													<option value="">请选择</option>
													<option value="CONVERT(name using gbk)">按名称</option>
													<option value="price">按价格</option>
													<option value="create_time">按创建时间</option>
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/hm/hm_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->