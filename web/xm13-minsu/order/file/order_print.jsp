...
<%
   ...
   // System.out.println("ddddd"+id);
    ...
    jsonObj=(JSONObject)session.getAttribute("order_file_get_record_result");
...
<script src="../../assets/module/scripts/order/file/order_print.js" type="text/javascript"></script>
