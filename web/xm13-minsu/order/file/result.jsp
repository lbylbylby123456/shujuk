							...
							<div class="portlet box blue ">
								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<input type="hidden" id="redirect_code" name="result_code" value="<%=resultCode %>"/>
                                      ...
                                      %>
                                        <button type="button" id="download_button" class="btn green">
                                            下载
                                        </button>
                                       <%
                                            }
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/order/file/result.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->