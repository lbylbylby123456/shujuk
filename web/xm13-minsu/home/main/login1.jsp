...
<head>
	...
	<style>
		body {
			background: url(../../assets/module/img/denglu.jpg) repeat-x;
		...
		* {
		...
		.kuico {
			background: url(../../assets/module/img/denglu.jpg) no-repeat;
		...
		.robot {
			background: url(../../assets/module/img/denglu1.jpg) no-repeat;
			display: inline-block;
			width: 18px;
			height: 20px;
			padding-right: 5px;
		...
		.question {
			background: url(../../assets/module/img/question.png) no-repeat;
			display: inline-block;
			width: 20px;
			height: 20px;
			padding-right: 5px;
		...
		.downApk {
			background: url(img/denglu1.jpg) no-repeat 30px;
			text-indent: 25px;
			display: inline-block;
			height: 32px;
			line-height: 32px;
		...
		.introduce {
			background: url(../../assets/module/img/question.png) no-repeat 20px;
			text-indent: 20px;
			display: inline-block;
			height: 32px;
			line-height: 32px;
		...
		#cloud {
			background: url(../../assets/module/img/cloud.png) repeat;
			width: 100%;
			height: 356px;
			position: absolute;
			bottom: 0px;
		...
		#sky {
			background: url(../../assets/module/img/denglu.jpg) repeat;
			width: 100%;
			heigth: 100%;
			z-index: -20;
			height: 100%;
...
<div id="middle">
	<form action="login1.action" method="post">
		...
		<ul style="text-align: center;">
			...
			<li></li>
			<li><span><a href="login2.jsp" style="color: blue;">找回密码</a>&nbsp; &nbsp;|&nbsp; &nbsp;
				<a href="register.jsp" style="color: blue;">注册</a></span></li>
...
<script src="../../assets/module/scripts/project/home/js/jquery-2.1.1.js" type="text/javascript" charset="UTF-8"></script>
