	...
	<main>
		...
		<div class="container margin_60_35">
            <div style="margin-bottom: 20px;">
                ...
                <button  id="submit_button" class="btn_1 rounded"> 添加</button>
            </div>
            ...
            <div class="form-group" >
                <label>图片名</label>
                <input onblur='fun1()' class="form-control" type="text" id="album_id" />
            </div>
            <div class="form-group"  >
                <label>图片简介</label>
...
<script type="text/javascript" src="../assets/module/scripts/album/album_add.js"></script>
