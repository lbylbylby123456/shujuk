...
<div id="page">
    ...
    <div class="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 text-right menu-1">
                        <ul>
                            ...
                            <li class="btn-cta"><a href="../view/view_WJ.jsp"><span><b>进行问卷调查</b></span></a></li>
                                <li class="btn-cta"><a href="../forum/forum_list.jsp"><span><b>返回发布评论</b></span></a></li>
                            ...
                            <%--<li class="btn-cta"><a href="../../project/addWJ/addWJ.jsp"><span><b>创建问卷</b></span></a></li>--%>
                        </ul>
                    </div>
                </div>
        ...
        <header id="gtco-header" class="gtco-cover" role="banner"
                style="background-image: url(../../assets/module/img/forum/wenjuandiaocha.jpg);height: 500px;">
                ...
                <div class="row row-p	b-md">
                    ...
                    <div class="col-md-18">
                        <div class="gtco-widget">
                            ...
                            <p>调查系统：用来供XM13民宿管理系统房东和房客进一步使用</p>
                        </div>
                    </div>
