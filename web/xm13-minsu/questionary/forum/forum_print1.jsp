...
<%
    ...
    jsonObj=(JSONObject)session.getAttribute("questionary_forum_get_record_result");
...
<div>
    ...
    <input type="button" class="no_print" value="返回" >
    </a>
<br>
<ul style="text-align: center;">
<font color="red">
请确保是否已经进入“统计”模块选择了相应的统计内容，否则会导出空表
</font>
</ul>
</div>
<body >
...
<script src="../../assets/module/scripts/questionary/forum/forum_print.js" type="text/javascript"></script>
<script src="../../assets/module/scripts/questionary/statistic/statistic_result.js" type="text/javascript"></script>
