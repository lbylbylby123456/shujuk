...
<script src="../../assets/module/scripts/cm/statistic_result.js" type="text/javascript"></script>
<script src="../../assets/module/scripts/cm/echarts.min.js" type="text/javascript"></script>
<script>

	function updateTableList(json){
		...
		$('.datatable').dataTable( {
			...
			"sAjaxSource":"../../CM_statistic_servlet_action?action="+action+"&exist_resultset=1"
		});
	...
	function getStatisticResult(){
		var action="get_statistic_record";
		var url="../../CM_statistic_servlet_action?action="+action+"&exist_resultset=1";
