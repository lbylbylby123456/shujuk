	...
	$.instagramFeed = function(options){
		...
		$.get(url, function(data){
			...
			if(options.display_profile){
				...
				html += "	<p class='instagram_username'"+ styles.profile_name +">@"+ data.full_name +" (<a href='"+ options.username +"'>@"+options.username+"</a>)</p>";
			}
