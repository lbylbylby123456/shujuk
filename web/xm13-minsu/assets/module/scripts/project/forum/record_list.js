...
var Record = function() {
	...
	//	html=html+"							<th> <input type=\"checkbox\" class=\"group-checkable\" data-set=\"#record_list .checkboxes\" /></th>";
		html=html+"							<th> <input type=\"checkbox\" class=\"group-checkable\"  /></th>";
		html=html+"							<th>事项标题</th>";
		html=html+"							<th>内容</th>";
		html=html+"							<th>评论备注（没有保持空白）</th>";
		html=html+"							<th>完成时间</th>";
		html=html+"							<th>警告备注（没有保持空白）</th>";
		html=html+"							<th>类型备注（后台设置）</th>";
		html=html+"						</tr>";
		$("#record_list_head").html(html);//改过
	};
