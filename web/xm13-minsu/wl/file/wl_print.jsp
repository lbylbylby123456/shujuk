...
<%
    ...
    if(existResultset!=null && existResultset.equals("1")){
        jsonObj=(JSONObject)session.getAttribute("project_wl_get_record_result");
    }
    ...
    <div>
        ...
        <div class=Section1 style='layout-grid: 15.6pt'>
            ...
            <p class=MsoNormal align=center style='text-align: center'>
                <b style='mso-bidi-font-weight: normal'><span style='font-size: 16.0pt; mso-bidi-font-size: 11.0pt; font-family: 宋体; mso-ascii-font-family: Calibri; mso-ascii-theme-font: minor-latin; mso-fareast-font-family: 宋体; mso-fareast-theme-font: minor-fareast; mso-hansi-font-family: Calibri; mso-hansi-theme-font: minor-latin'>心愿清单列表</span>
...
//                            String id=(String)list.get(0);
                            ...
                            String address = (String)list.get(2)+(String)list.get(3)+(String)list.get(4)+(String)list.get(5);
                            String price = (String)list.get(6);
        ...
        <script>
            function returnBack(){
                window.location.href="wl_list.jsp";
            }
        </script>
        </html>
