								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">文章标题(毕填)<font color="red">*</font></label>
												<div class="col-md-9">
											...
											<div class="form-group">
												...
												<label class="control-label col-md-3">
													请选择文章发布的时间段<font color="red">*</font>
												</label>
												<div class="col-md-6">
													<span>从</span>
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/article/file/article_query.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->