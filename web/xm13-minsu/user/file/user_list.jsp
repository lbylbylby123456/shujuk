										...
										<div class="form-group">
											...
											<div class="col-md-2">
												<select class="bs-select form-control" id="sort_01" onchange="Page.sortRecord(1);">
													...
													<option value="limit_time">按处理时间</option>
													<option value="title">按职员名</option>
													<option value="city">按职位</option>
												</select>
											</div>
											<div class="col-md-2">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/user/file/user_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->