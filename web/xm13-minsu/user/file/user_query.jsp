								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">职员名称（必填）<font color="red">*</font></label>
												<div class="col-md-9">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/user/file/user_query.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->