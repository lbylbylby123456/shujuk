									...
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											<div class="form-group">
												<label class="col-md-3 control-label">职员名称<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="title" name="title" class="form-control" placeholder="请填写标题" value=""/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">职员邮箱<font color="red">*</font></label>
												<div class="col-md-9">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" id="gender" name="gender" class="form-control" placeholder="请输入内容" value=""/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">职位</label>
												<div class="col-md-9">
													<input type="text" id="city" name="city" class="form-control" placeholder="请输入内容" value=""/>
												</div>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/user/file/user_add.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->
