									...
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input onblur='fun1()' type="text" id="title" name="title" class="form-control" placeholder="请填写民宿的名称" value=""/>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<input onblur='fun2()' type="text" id="content" name="content" class="form-control" placeholder="请输入评价的相关内容" value=""/>
												</div>
												<font color="red">（填入中文或英文内容）</font>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/project/forum/forum_add.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->
