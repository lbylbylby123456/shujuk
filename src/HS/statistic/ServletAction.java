...
//	public String resultPath = module + "/" + sub;
	public String resultPath = "hs/statistic";
...
//			int resultCode=0;
//			redirectUrl="../hs/hs_list.jsp";
//			resultMsg=java.net.URLEncoder.encode(resultMsg, "UTF-8");
//			resultUrl=resultPath+"/hs_statistic_result.jsp";
...
//    	String chartFilename ="hs_static_" +(new SimpleDateFormat("yyyyMMddHHmmss")).format(new Date())+".jpg";
