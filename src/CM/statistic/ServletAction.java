...
import CM.dao.Statistic;
import CM.dao.StatisticDao;
...
//		String fileName=getStatisticGraph(session,dbName,jsonObj,"待办事项统计图","测试Column",statisticType,1,1280,768);
		...
		if(isAjax){
			...
			int resultCode=0;
			redirectUrl="../CheckManage/CM_list.jsp";
			resultMsg=java.net.URLEncoder.encode(resultMsg, "UTF-8");
			resultUrl=resultPath+"/CM_statistic_result.jsp";
