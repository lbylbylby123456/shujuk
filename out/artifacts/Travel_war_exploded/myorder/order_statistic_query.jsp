	...
	<main>
		...
		<div class="container margin_60_35">
            <div style="margin-bottom: 20px;">
                ...
                <button  id="submit_button" class="btn_1 rounded"> 统计</button>
            </div>
            <form id="page_form" role="form" >
                ...
                <div class="form-group" >
                    ...
                    <div class="form-group col-md-3"  >
                        <label>统计内容</label>
                        <input onblur='fun1()' class="form-control" type="text" id="content" name="content"/>
                    </div>
                <div class="form-group">
...
<script type="text/javascript" src="../assets/module/scripts/myorder/order_statistic_query.js"></script>
