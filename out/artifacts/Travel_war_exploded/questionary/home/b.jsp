    ...
    <div class="one">
        <table class="table" style="background-color: #333333">
            ...
            <%--<tr class="container-fluid" align="center">--%>
                <td class="col-xs-6"><a href="home.jsp"><h4 style="color: deepskyblue">问卷调查首页</h4></a></td>
                <td class="col-xs-6"><a href="../view/view_WJ.jsp"><h4 style="color:green">问卷大类一览</h4></a></td>
