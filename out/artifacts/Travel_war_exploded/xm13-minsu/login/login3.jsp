...
<div id="middle">
    ...
    <form action="login3.action" method="post">
        <ul style="text-align: center;">
            <li style="font-size: 48px">房&nbsp;东&nbsp;用&nbsp;户&nbsp;登&nbsp;录</li>

            <li><input class="name" name="username_d" placeholder="请输入用户名" style="margin-top: 25px;"></li>
            <li><input type="password" name="password_d" class="pwd" placeholder="请输入密码"></li>
            ...
            <li><span><a href="login1.jsp" style="color: white;">普通用户登录</a>&nbsp; &nbsp;|&nbsp; &nbsp;
                <a href="login2.jsp" style="color: white;">后台管理员登录</a>&nbsp; &nbsp;|&nbsp; &nbsp;
				<a href="register3.jsp" style="color: white;">注册</a></span></li>
