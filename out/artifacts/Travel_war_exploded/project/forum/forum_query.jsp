								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">民宿评论标题名称（支持不完全查询）</label>
												<div class="col-md-3">
											...
											<div class="form-group">
												...
												<label class="control-label col-md-3">
													请选择发布的时间段（默认为0点）<font color="red">*</font>
												</label>
												<div class="col-md-6">
...
<script src="../../assets/module/scripts/project/forum/forum_query.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script language=javascript>
	...
	function fun1()
	{
		...
		if(c==null || c==""){
			Frame.showMsg("内容为空则查出全部个人内容");bOk=false;
		}
	}
	function fun2()
	{
