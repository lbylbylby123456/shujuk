...
<div id="background" style="position:absolute;z-index:-1;width:100%;height:100%;top:0px;left:0px;">
    <img src="../../assets/module/scripts/project/home/img/tongji.png" width="100%" height="100%"/>
</div>
<p style="color: green; font-size: 30px;margin-top: 400px;" align="left"><b><i>可以进行问卷的统计结果查询</i></b></p>
