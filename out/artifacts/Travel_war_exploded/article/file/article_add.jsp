									...
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											<div class="form-group">
												<label class="col-md-3 control-label">文章标题<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="title" name="title" class="form-control" placeholder="请填写标题" value=""/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">文章内容<font color="red">*</font></label>
												<div class="col-md-9">
													<textarea style="height:500px;" type="text" id="content" name="content" class="form-control" placeholder="请输入内容" value="">
													</textarea>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input  type="text" id="author" name="author" class="form-control" placeholder="请输入内容" value=""/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">标签</label>
												<div class="col-md-9">
													<input type="text" id="tag" name="tag" class="form-control" placeholder="请输入内容" value=""/>
												</div>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/article/file/article_add.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->
