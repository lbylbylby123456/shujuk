...
<%
   ...
   // System.out.println("ddddd"+id);
    ...
    jsonObj=(JSONObject)session.getAttribute("album_file_record_result");
...
<script src="../assets/module/scripts/album/album_statistic_print.js" type="text/javascript"></script>
