						...
						<div class="portlet box blue ">
							<div class="portlet-title">
								...
								<div class="actions">
									...
									<a href="order_statistic_print.jsp" class="btn btn-default btn-sm"><i class="fa fa-print"></i> 打印 </a>
...
<script src="../../assets/module/scripts/order/statistic/statistic_result.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
