								...
								<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
									...
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<select class="table-group-action-input form-control input-medium" id="statistic_type" name="statistic_type">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">统计内容</label>
                                                <div class="col-md-2">
                                                <input onblur='fun1()'  type="text" id="content" name="content" class="form-control" placeholder="请填写内容" value="">
                                                </div>
											</div>
									</div>
								</form>
...
<script type="text/javascript" src="../../assets/module/scripts/order/statistic/order_statistic_query.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->
