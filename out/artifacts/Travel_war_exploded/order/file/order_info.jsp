								...
								<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
									...
									<div class="form-body">
                                        <div class="form-group">
                                            <div style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 20px; margin-top: 10px;">
                                                ...
                                                <button type="button" id="modify_button" class="btn green" title="修改记录">
                                                    修改
                                                </button>
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/order/file/order_info.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
