...
!function( $ ) {
	...
	Datetimepicker.prototype = {
		...
		fill: function() {
			...
			//newadd
			var addSec = /,s{1,2},/.test(',' + this.format.parts.join(',') + ','), sSec =
					...
					case 'span':
						if (!target.is('.disabled')) {
							...
							$('.form_datetime').datetimepicker({
								weekStart: 1, todayBtn: 1, autoclose: 1, todayHighlight: 1, startView: 2, forceParse: 0, showMeridian: 1, format: 'yyyy-mm-dd hh:ii:ss'///
							});
