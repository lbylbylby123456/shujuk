...
//new_element.setAttribute("src","../../assets/module/scripts/hm/echarts.min.js");// 在这里引入了a.js
...
var Record = function() {
	...
	//}
	//var showStatisticImage=function(list){
...
var Page = function() {
	...
	var printRecord=function(){
		var url="hm_statistic_print.jsp?exist_resultset=1";
		window.open(url);
	};
	var statisticQuery=function(){
		window.location.href="hm_statistic_query.jsp";
	};
	return {
		init: function() {
			initPageStyle();
