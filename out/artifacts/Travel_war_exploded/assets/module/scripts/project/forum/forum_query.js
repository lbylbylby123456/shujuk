...
var Page = function() {
	...
	var showRecord = function(json){
		...
		html=html+"																<span>"+json[1]+"</span><p>";
		html=html+"																<span>"+json[2]+"</span><p>";
		html=html+"																<span>"+json[4]+"</span><p>";
		html=html+"																<span>"+json[6]+"</span><p>";
		//html=html+"																<span>"+json[3]+"</span><p>";
		//html=html+"																<span>"+json[4]+"</span><p>";
	...
	var yestodayTime=function(){
		...
		//$("#time_to").val(yestoday.format("yyyy-MM-dd")+" 23:59:59");//改了
		$("#time_from").val(yestoday.format("yyyy-MM-dd"));
		$("#time_to").val(yestoday.format("yyyy-MM-dd"));
	};
	var beforeYestodayTime=function(){
		...
		$("#time_from").val(beforeYestoday.format("yyyy-MM-dd"));
		$("#time_to").val(beforeYestoday.format("yyyy-MM-dd"));
	};
	var monthTime=function(){
		...
		firstDay=ComponentsPickers.formatDate(ComponentsPickers.parseDate(firstDay),"yyyy-MM-dd");
		//var nowDay=ComponentsPickers.formatDate(today,"yyyy-MM-dd")+" 23:59:59";
		var nowDay=ComponentsPickers.formatDate(today,"yyyy-MM-dd");
