function a() {
    ...
    // request.open("POST", "addquestion.action",false);
    // request.send(fd);
    ...
    $.ajax({
        ...
        success: function (response) {
            //window.location.href="../view/view_WJ.jsp"
			window.location.href="../home/home1.jsp"
        }
    });
}
$(document).ready(function(e) {
			 $('#addquerstions').change(function() {
		            ...
		            $(movie_box).hover(function() {
		                var html_cz = "<div class='kzqy_czbut'><a href='javascript:void(0)' class='sy'>上移</a><a href='javascript:void(0)'  class='xy'>下移</a><a href='javascript:void(0)'  class='bianji'>修改</a><a href='javascript:void(0)' class='del' >删除</a></div>"
		                $(this).css({
			...
			/*	$(".btwen_text").val("题目");
				...
				//鼠标移上去显示按钮
				$(".movie_box").hover(function() {
					var html_cz = "<div class='kzqy_czbut'><a href='javascript:void(0)' class='sy'>上移</a><a href='javascript:void(0)'  class='xy'>下移</a><a href='javascript:void(0)'  class='bianji'>题目修改</a><a href='javascript:void(0)' class='del' >删除</a></div>"
					$(this).css({
						"border": "1px solid #0099ff"
					});
					$(this).children(".wjdc_list").after(html_cz);
