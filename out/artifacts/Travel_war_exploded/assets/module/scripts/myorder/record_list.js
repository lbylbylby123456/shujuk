...
var Record = function() {
	...
	var initRecordList=function()
	{
     //   var id=document.getElementById("id").value;
		...
		$('.datatable').dataTable( {
			...
			{
                //alert(data);
				//sReturn = '<div style="width:100px;"><a onclick=\"Page.modifyRecord('+data+')\"><span onclick=\"Page.modifyRecord()\" class=\"\" title="修改"><i class=\"icon-pencil\"></i></span></a><a href="javascript:Record.deleteRecord('+data+')"><span class=\"\" title="删除"><i class=\"icon-trash\"></i></span></a></div>';
                //var x;
				sReturn = '<div style="width:100px;"><a onclick=\"Page.modifyRecord('+data+')\"><span onclick=\"Page.modifyRecord()\" class=\"\" title="修改"><i class=\"icon-pencil\"></i></span></a></div>';
				//if(x=0)
				//sReturn = '<div style="width:100px;"><a onclick=\"Page.addRecord('+data+')\"><span onclick=\"Page.addRecord()\" class=\"\" title="添加"><i class=\"icon-pencil\"></i></span></a></div>';
				return sReturn;
					},"orderable": false
				},{},{},{},{},{},{},{},{},{}],
			...
			"sAjaxSource": "../"+module+"_"+sub+"_servlet_action?action=query_record&search="+search+"&searchName="+searchName+"&time_from="+time_from+"&time_to="+time_to
		});
	...
	var addRecord=function(id){
		//$("#record_modify_div").show();
		//  var id=document.getElementById("id").value;
		window.location.href="order_add.jsp?id="+id;
	}
