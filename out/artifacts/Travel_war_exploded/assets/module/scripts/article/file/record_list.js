...
jQuery(document).ready(function() {
	console.log("record_list:js初始化执行开始！");
	...
	Page.init();
	Record.init();
	console.log("record_list:js初始化执行完毕！");
});
/* ================================================================================ */
var Record = function() {
	var userId;
	...
	var initRecordListHeader = function() {
		...
		html=html+"							<th>文章标题</th>";
		html=html+"							<th>文章内容</th>";
		html=html+"							<th>作者</th>";
		html=html+"							<th>标签</th>";
		html=html+"							<th>id号</th>";
		html=html+"							<th>处理时间</th>";
		html=html+"						</tr>";
	...
	var addNew=function(){
		...
		var gender=encodeURI(documentt.getElementById("gender").value);
		...
		var url="../../"+module+"_"+sub+"_servlet_action?action=add_record"+
			"&project_id="+projectId+"&title="+title+"&content="+content+"&gender="+gender+"&city="+city+"&executor="+
	...
	var modifyRecord1=function(){
		...
		var url="../../"+module+"_"+sub+"_servlet_action?action=modify_record"+
			"&id="+id+"&project_id="+projectId+"&title="+title+"&content="+content+"&gender="+gender+"&city="+city+"&begin_time="+
